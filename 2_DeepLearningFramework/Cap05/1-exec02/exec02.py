...
my_tensor = _________________________
print('\nTensor com 20 zeros')
print(my_tensor)

# Declara a variável que recebe um tensor preenchido por 20 zeros
my_var = _________________________
print('\nmy_var')
print(my_var)
